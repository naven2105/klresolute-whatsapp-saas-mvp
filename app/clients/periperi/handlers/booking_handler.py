...
# Path: app/clients/periperi/handlers/booking_handler.py
# Project: KLResolute WhatsApp SaaS MVP
#
# Sprint 16 – periperi Booking Handler Extraction
#
# Purpose:
# Dedicated periperi booking handler
#
# Update:
...
logger = logging.getLogger("periperi.booking_handler")
...
def handle_booking(
    ...
    db.execute(
        text(
            """
            INSERT INTO r_periperi__booking_requests
