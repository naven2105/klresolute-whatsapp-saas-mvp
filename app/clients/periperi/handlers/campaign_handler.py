...
# Path: app/clients/periperi/handlers/campaign_handler.py
# Project: KLResolute WhatsApp SaaS MVP
#
# Sprint 24 – Admin Menu Isolation
#
# Purpose:
# Handles periperi admin campaign flow:
...
logger = logging.getLogger("periperi.campaign_handler")
...
def _execute_broadcast(
    ...
    campaign_id = db.execute(
        text(
            """
            INSERT INTO r_periperi__campaigns
    ...
    for row in recipients:
        ...
        db.execute(
            text(
                """
                INSERT INTO r_periperi__broadcast_logs
