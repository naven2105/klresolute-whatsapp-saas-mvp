...
Path: app/clients/periperi/customer/booking_service.py
Project: KLResolute WhatsApp SaaS MVP

Purpose:
periperi customer booking command handling (tenant-local).
...
from app.clients.periperi.handlers.booking_handler import handle_booking
