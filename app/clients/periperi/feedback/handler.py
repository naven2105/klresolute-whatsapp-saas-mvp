...
"""
File: app/clients/periperi/feedback/handler.py
Project: KLResolute WhatsApp SaaS MVP

Purpose:
periperi-specific feedback handler (tenant-isolated).

Rules:
- Trigger: "feedback:"
- Store in r_periperi__feedback
...
logger = logging.getLogger("periperi.feedback")
    ...
    *,
    ...
    try:
        ...
        db.execute(
            text(
                """
                INSERT INTO r_periperi__feedback
