...
# Path: app/clients/periperi/survey/survey_handler.py
...
from app.clients.periperi.survey.summary import build_survey_summary_text

logger = logging.getLogger("periperi.survey_handler")
    ...
    try:
        ...
        if text_clean.upper().startswith("SURVEY:"):
            ...
            db.execute(
                text(
                    """
                    INSERT INTO r_periperi__surveys (
                        id,
                        question,
                        started_at,
                        ends_at,
