...
Path: app/clients/periperi/survey/survey_expiry_notifier.py
Project: KLResolute WhatsApp SaaS MVP

Purpose:
Background notifier that auto-closes expired periperi surveys.

Rules:
- Tenant isolated
- Uses r_periperi__surveys
...
logger = logging.getLogger("periperi.survey_expiry_notifier")
