# ==================================================
# File: dispatcher.py
# Path: app/clients/periperi/dispatcher.py
...
from app.clients.periperi.inbound import handle_periperi_inbound
from app.clients.periperi.feedback.handler import (
    handle_feedback_message as periperi_feedback_handler,
)
...
def dispatch(
    *,
    ...
    logger.info(
        "PERIPERI_DISPATCH_ENTER | sender=%s | msg_type=%s",
        sender,
        msg.get("type"),
    )
    ...
    if msg_type == "button":
        ...
        from app.clients.periperi.survey.survey_response_handler import (
    ...
    if msg_type == "text":
        ...
        if body_text.lower().startswith("feedback:"):
            ...
            handled = periperi_feedback_handler(
                db=db,
    ...
    logger.info("PERIPERI_DISPATCH_TERMINATE_SAFE")
