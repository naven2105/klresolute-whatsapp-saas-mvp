...
"""
File: app/clients/rusticbarrel/feedback/handler.py
Project: KLResolute WhatsApp SaaS MVP

Purpose:
Rustic Barrel-specific feedback handler (tenant-isolated).
...
logger = logging.getLogger("rusticbarrel.feedback")
