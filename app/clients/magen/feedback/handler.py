...
"""
File: app/clients/magen/feedback/handler.py
Project: KLResolute WhatsApp SaaS MVP

Sprint 13 – Client Feedback Isolation (Magen)

Purpose:
Magen-specific feedback handler.
...
logger = logging.getLogger("magen.feedback")

ADMIN_TEMPLATE_NAME = MAGEN_INSPECTION_COMPLETED
CUSTOMER_ACK_TEMPLATE_NAME = MAGEN_INSPECTION_COMPLETED
