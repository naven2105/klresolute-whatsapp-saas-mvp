...
Purpose:
Inspection lifecycle operations for Magen Security.

Responsibilities (LOCKED):
- Fetch active inspection
- Start inspection
- Close inspection
...
logger = logging.getLogger("clients.magen.inspection")
...
def start_inspection(db: Session, *, sender: str) -> int:
    ...
    logger.info(
        "MAGEN_INSPECTION_STARTED | sender=%s | id=%s",
        sender,
        inspection_id,
    )
