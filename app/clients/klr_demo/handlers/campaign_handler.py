...
# Path: app/clients/klr_demo/handlers/campaign_handler.py
# Project: KLResolute WhatsApp SaaS MVP
#
# Sprint 24 – Admin Menu Isolation
#
# Purpose:
# Handles klr_demo admin campaign flow:
...
logger = logging.getLogger("klr_demo.campaign_handler")
...
def _execute_broadcast(
    ...
    campaign_id = db.execute(
        text(
            """
            INSERT INTO r_klr_demo__campaigns
    ...
    for row in recipients:
        ...
        db.execute(
            text(
                """
                INSERT INTO r_klr_demo__broadcast_logs
