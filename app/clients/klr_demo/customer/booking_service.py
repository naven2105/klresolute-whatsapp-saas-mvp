...
Path: app/clients/klr_demo/customer/booking_service.py
Project: KLResolute WhatsApp SaaS MVP

Purpose:
klr_demo customer booking command handling (tenant-local).
...
from app.clients.klr_demo.handlers.booking_handler import handle_booking
