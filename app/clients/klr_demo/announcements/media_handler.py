...
"""
File: app/client/klr_demo/announcements/media_handler.py
...
from app.messaging.template_registry import KLR_CAMPAIGN_TEMPLATE
...
def handle_media_message(
    *,
    ...
    try:
        meta.send_template(
            to_msisdn=sender,
            template_name=KLR_CAMPAIGN_TEMPLATE,
            body_params=[
