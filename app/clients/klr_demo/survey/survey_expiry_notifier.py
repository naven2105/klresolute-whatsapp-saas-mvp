...
Path: app/clients/klr_demo/survey/survey_expiry_notifier.py
Project: KLResolute WhatsApp SaaS MVP

Purpose:
Background notifier that auto-closes expired klr_demo surveys.

Rules:
- Tenant isolated
- Uses r_klr_demo__surveys
...
logger = logging.getLogger("klr_demo.survey_expiry_notifier")
