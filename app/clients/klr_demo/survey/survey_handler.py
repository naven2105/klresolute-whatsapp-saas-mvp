...
# Path: app/clients/klr_demo/survey/survey_handler.py
...
from app.clients.klr_demo.survey.summary import build_survey_summary_text

logger = logging.getLogger("klr_demo.survey_handler")
    ...
    try:
        ...
        if text_clean.upper().startswith("SURVEY:"):
            ...
            db.execute(
                text(
                    """
                    INSERT INTO r_klr_demo__surveys (
                        id,
                        question,
                        started_at,
                        ends_at,
