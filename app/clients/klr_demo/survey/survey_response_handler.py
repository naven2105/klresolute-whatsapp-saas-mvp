...
# Path: app/clients/klr_demo/survey/survey_response_handler.py
...
logger = logging.getLogger("klr_demo.survey_response_handler")
    ...
    *,
    ...
    try:
        ...
        db.execute(
            text(
                """
                INSERT INTO r_klr_demo__survey_responses (
                    id,
                    survey_id,
                    client_number,
                    button_id,
